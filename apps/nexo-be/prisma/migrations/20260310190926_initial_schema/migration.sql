...
-- CreateIndex
CREATE INDEX "Subscription_advertiserId_status_idx" ON "Subscription"("advertiserId", "status");
...
-- CreateIndex
CREATE INDEX "Notification_advertiserId_idx" ON "Notification"("advertiserId");
...
-- CreateIndex
CREATE INDEX "ActivityLog_advertiserId_idx" ON "ActivityLog"("advertiserId");

-- CreateIndex
CREATE INDEX "ActivityLog_createdAt_idx" ON "ActivityLog"("createdAt");

-- AddForeignKey
ALTER TABLE "Subscription" ADD CONSTRAINT "Subscription_advertiserId_fkey" FOREIGN KEY ("advertiserId") REFERENCES "Advertiser"("id") ON DELETE CASCADE ON UPDATE CASCADE;
